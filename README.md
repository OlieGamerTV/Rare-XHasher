...
The tool requires two arguments, the hashing argument (-base/-typed) and the filename of choice.
...
## Notice
The hashes this tool generates currently <b>only</b> support the games developed by the Banjo team at Rare, due to the shared engine and thus similar hashing code.<br/>
While other teams at Rare also had some hashed strings (such as Kameo & Perfect Dark Zero), those appear to be generated differently and thus aren't implemented yet.
